...
[version]$appDeployHelpScriptVersion = [version]'3.9.1'
[string]$appDeployHelpScriptDate = '20/01/2023'
...
Set-Alias -Name 'Get-PSADTHelp' -Value 'Show-HelpConsole' -Scope 'Global' -Force -ErrorAction 'SilentlyContinue'
